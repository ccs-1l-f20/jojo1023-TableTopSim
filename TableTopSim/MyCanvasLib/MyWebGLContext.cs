...
{
    public class MyWebGLContext : MyRenderingContext
    {
        #region Constants
        ...
        internal MyWebGLContext(MyCanvasClass reference, WebGLContextAttributes attributes = null) : base(reference, CONTEXT_NAME, attributes)
        {
        }
