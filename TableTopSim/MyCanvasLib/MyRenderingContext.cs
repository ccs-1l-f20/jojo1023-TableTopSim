...
{
    public abstract class MyRenderingContext : IDisposable
    {
        ...
        internal MyRenderingContext(MyCanvasClass reference, string contextName, object parameters = null)
        {
...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        internal async Task<MyRenderingContext> InitializeAsync()
        {
